...
class HyperParams:
    def __init__(self):
        ...
        self.gsv_cities_path: str = "/datasets/gsv_cities"                  # or path to gsv-cities in this project
        ...
        # self.val_sets: dict = {
        #     "msls-val":     "/datasets/msls/msls/val",              # path to the msls-val dataset
        #     "pitts30k-val": "/datasets/pitts30k/images/val",          # path to the pitts30k-val dataset
        # }
